...
function Folder({ name, deleteFolder, onSelectFolder }) {
  
  const deleteFolderHandler = () => {
    if(window.confirm("Вы точно хотите удалить папку?")){
      deleteFolder(name);
    }
  ...
  return (
    <div className="list__item">
      <div className="item__text" onClick={selectFolderHandler}>{name}</div>
      <svg
